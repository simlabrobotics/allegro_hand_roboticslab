...
#ifndef __RDEVICEERHANDESDCAN_H__
#define __RDEVICEERHANDESDCAN_H__
...
class rDeviceERHandESDCAN : public RD_DEVICE_CLASS(Base)
{
	RD_VERSION(1.0)
	RD_AUTHOR(SimLab)

public:
	RD_DECLARE_CTOR(ERHandESDCAN);
	RD_DECLARE_DTOR(ERHandESDCAN);
