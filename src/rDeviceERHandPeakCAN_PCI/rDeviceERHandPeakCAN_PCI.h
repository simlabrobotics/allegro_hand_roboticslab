...
#ifndef __RDEVICEERHANDPEAKCAN_H__
#define __RDEVICEERHANDPEAKCAN_H__
...
class rDeviceERHandPeakCAN : public RD_DEVICE_CLASS(Base)
{
	RD_VERSION(1.0);
	RD_AUTHOR(Sangyup Yi);

public:
	RD_DECLARE_CTOR(ERHandPeakCAN);
	RD_DECLARE_DTOR(ERHandPeakCAN);
