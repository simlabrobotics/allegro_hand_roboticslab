...
#ifndef __RDEVICEERHANDKVASERCAN_H__
#define __RDEVICEERHANDKVASERCAN_H__
...
class rDeviceERHandKvaserCAN : public RD_DEVICE_CLASS(Base)
{
	RD_VERSION(1.0)
	RD_AUTHOR(SimLab)

public:
	RD_DECLARE_CTOR(ERHandKvaserCAN);
	RD_DECLARE_DTOR(ERHandKvaserCAN);
