...
#ifndef __RDEVICEERHANDNICAN_H__
#define __RDEVICEERHANDNICAN_H__
...
class rDeviceERHandNICAN : public RD_DEVICE_CLASS(Base)
{
	RD_VERSION(1.0)
	RD_AUTHOR(SimLab)

public:
	RD_DECLARE_CTOR(ERHandNICAN);
	RD_DECLARE_DTOR(ERHandNICAN);
